...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_6")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_6/Model6.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_6/Model6.est")
  
  setwd("~/Desktop/CNN_part_II/Model_6/Simulations")
  ...
  write(tpl, "./Model6.tpl")
  write(est, "./Model6.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_6/Simulations/sim",t,"/Model6.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_6/Simulations/sim",t,"/Model6.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model6"))
  
  out <- readLines("Model6_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_6/Model6_dataset/CNN_Model6_", t, ".png"),height=n_seqs, width=snps_observed)
