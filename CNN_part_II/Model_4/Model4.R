...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_4")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_4/Model4.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_4/Model4.est")
  
  setwd("~/Desktop/CNN_part_II/Model_4/Simulations")
  ...
  write(tpl, "./Model4.tpl")
  write(est, "./Model4.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_4/Simulations/sim",t,"/Model4.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_4/Simulations/sim",t,"/Model4.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model4"))
  
  out <- readLines("Model4_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_4/Model4_dataset/CNN_Model4_", t, ".png"),height=n_seqs, width=snps_observed)
