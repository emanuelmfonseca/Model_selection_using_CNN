...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_21")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_21/Model21.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_21/Model21.est")
  
  setwd("~/Desktop/CNN_part_II/Model_21/Simulations")
  ...
  write(tpl, "./Model21.tpl")
  write(est, "./Model21.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_21/Simulations/sim",t,"/Model21.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_21/Simulations/sim",t,"/Model21.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model21"))
  
  out <- readLines("Model21_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_21/Model21_dataset/CNN_Model21_", t, ".png"),height=n_seqs, width=snps_observed)
