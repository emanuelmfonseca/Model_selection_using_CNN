...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_26")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_26/Model26.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_26/Model26.est")
  
  setwd("~/Desktop/CNN_part_II/Model_26/Simulations")
  ...
  write(tpl, "./Model26.tpl")
  write(est, "./Model26.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_26/Simulations/sim",t,"/Model26.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_26/Simulations/sim",t,"/Model26.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model26"))
  
  out <- readLines("Model26_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_26/Model26_dataset/CNN_Model26_", t, ".png"),height=n_seqs, width=snps_observed)
