...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_3")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_3/Model3.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_3/Model3.est")
  
  setwd("~/Desktop/CNN_part_II/Model_3/Simulations")
  ...
  write(tpl, "./Model3.tpl")
  write(est, "./Model3.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_3/Simulations/sim",t,"/Model3.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_3/Simulations/sim",t,"/Model3.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model3"))
  
  out <- readLines("Model3_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_3/Model3_dataset/CNN_Model3_", t, ".png"),height=n_seqs, width=snps_observed)
