...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_12")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_12/Model12.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_12/Model12.est")
  
  setwd("~/Desktop/CNN_part_II/Model_12/Simulations")
  ...
  write(tpl, "./Model12.tpl")
  write(est, "./Model12.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_12/Simulations/sim",t,"/Model12.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_12/Simulations/sim",t,"/Model12.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model12"))
  
  out <- readLines("Model12_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_12/Model12_dataset/CNN_Model12_", t, ".png"),height=n_seqs, width=snps_observed)
