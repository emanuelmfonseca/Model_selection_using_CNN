...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_8")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_8/Model8.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_8/Model8.est")
  
  setwd("~/Desktop/CNN_part_II/Model_8/Simulations")
  ...
  write(tpl, "./Model8.tpl")
  write(est, "./Model8.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_8/Simulations/sim",t,"/Model8.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_8/Simulations/sim",t,"/Model8.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model8"))
  
  out <- readLines("Model8_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_8/Model8_dataset/CNN_Model8_", t, ".png"),height=n_seqs, width=snps_observed)
