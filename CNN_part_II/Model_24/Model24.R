...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_24")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_24/Model24.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_24/Model24.est")
  
  setwd("~/Desktop/CNN_part_II/Model_24/Simulations")
  ...
  write(tpl, "./Model24.tpl")
  write(est, "./Model24.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_24/Simulations/sim",t,"/Model24.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_24/Simulations/sim",t,"/Model24.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model24"))
  
  out <- readLines("Model24_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_24/Model24_dataset/CNN_Model24_", t, ".png"),height=n_seqs, width=snps_observed)
