...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_7")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_7/Model7.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_7/Model7.est")
  
  setwd("~/Desktop/CNN_part_II/Model_7/Simulations")
  ...
  write(tpl, "./Model7.tpl")
  write(est, "./Model7.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_7/Simulations/sim",t,"/Model7.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_7/Simulations/sim",t,"/Model7.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model7"))
  
  out <- readLines("Model7_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_7/Model7_dataset/CNN_Model7_", t, ".png"),height=n_seqs, width=snps_observed)
