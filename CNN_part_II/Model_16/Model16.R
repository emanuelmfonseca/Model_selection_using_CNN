...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_16")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_16/Model16.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_16/Model16.est")
  
  setwd("~/Desktop/CNN_part_II/Model_16/Simulations")
  ...
  write(tpl, "./Model16.tpl")
  write(est, "./Model16.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_16/Simulations/sim",t,"/Model16.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_16/Simulations/sim",t,"/Model16.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model16"))
  
  out <- readLines("Model16_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_16/Model16_dataset/CNN_Model16_", t, ".png"),height=n_seqs, width=snps_observed)
