...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_1")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_1/Model1.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_1/Model1.est")
  
  setwd("~/Desktop/CNN_part_II/Model_1/Simulations")
  ...
  write(tpl, "./Model1.tpl")
  write(est, "./Model1.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_1/Simulations/sim",t,"/Model1.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_1/Simulations/sim",t,"/Model1.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model1"))
  
  out <- readLines("Model1_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_1/Model1_dataset/CNN_Model1_", t, ".png"),height=n_seqs, width=snps_observed)
