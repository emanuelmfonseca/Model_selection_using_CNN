...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_19")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_19/Model19.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_19/Model19.est")
  
  setwd("~/Desktop/CNN_part_II/Model_19/Simulations")
  ...
  write(tpl, "./Model19.tpl")
  write(est, "./Model19.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_19/Simulations/sim",t,"/Model19.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_19/Simulations/sim",t,"/Model19.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model19"))
  
  out <- readLines("Model19_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_19/Model19_dataset/CNN_Model19_", t, ".png"),height=n_seqs, width=snps_observed)
