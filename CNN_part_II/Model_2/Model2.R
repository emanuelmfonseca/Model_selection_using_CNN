...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_2")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_2/Model2.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_2/Model2.est")
  
  setwd("~/Desktop/CNN_part_II/Model_2/Simulations")
  ...
  write(tpl, "./Model2.tpl")
  write(est, "./Model2.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_2/Simulations/sim",t,"/Model2.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_2/Simulations/sim",t,"/Model2.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model2"))
  
  out <- readLines("Model2_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_2/Model2_dataset/CNN_Model2_", t, ".png"),height=n_seqs, width=snps_observed)
