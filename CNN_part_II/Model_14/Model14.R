...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_14")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_14/Model14.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_14/Model14.est")
  
  setwd("~/Desktop/CNN_part_II/Model_14/Simulations")
  ...
  write(tpl, "./Model14.tpl")
  write(est, "./Model14.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_14/Simulations/sim",t,"/Model14.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_14/Simulations/sim",t,"/Model14.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model14"))
  
  out <- readLines("Model14_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_14/Model14_dataset/CNN_Model14_", t, ".png"),height=n_seqs, width=snps_observed)
