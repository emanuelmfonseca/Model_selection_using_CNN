...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_20")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_20/Model20.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_20/Model20.est")
  
  setwd("~/Desktop/CNN_part_II/Model_20/Simulations")
  ...
  write(tpl, "./Model20.tpl")
  write(est, "./Model20.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_20/Simulations/sim",t,"/Model20.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_20/Simulations/sim",t,"/Model20.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model20"))
  
  out <- readLines("Model20_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_20/Model20_dataset/CNN_Model20_", t, ".png"),height=n_seqs, width=snps_observed)
