...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_9")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_9/Model9.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_9/Model9.est")
  
  setwd("~/Desktop/CNN_part_II/Model_9/Simulations")
  ...
  write(tpl, "./Model9.tpl")
  write(est, "./Model9.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_9/Simulations/sim",t,"/Model9.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_9/Simulations/sim",t,"/Model9.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model9"))
  
  out <- readLines("Model9_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_9/Model9_dataset/CNN_Model9_", t, ".png"),height=n_seqs, width=snps_observed)
