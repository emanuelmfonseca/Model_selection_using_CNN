...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_18")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_18/Model18.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_18/Model18.est")
  
  setwd("~/Desktop/CNN_part_II/Model_18/Simulations")
  ...
  write(tpl, "./Model18.tpl")
  write(est, "./Model18.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_18/Simulations/sim",t,"/Model18.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_18/Simulations/sim",t,"/Model18.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model18"))
  
  out <- readLines("Model18_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_18/Model18_dataset/CNN_Model18_", t, ".png"),height=n_seqs, width=snps_observed)
