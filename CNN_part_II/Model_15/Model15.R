...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_15")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_15/Model15.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_15/Model15.est")
  
  setwd("~/Desktop/CNN_part_II/Model_15/Simulations")
  ...
  write(tpl, "./Model15.tpl")
  write(est, "./Model15.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_15/Simulations/sim",t,"/Model15.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_15/Simulations/sim",t,"/Model15.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model15"))
  
  out <- readLines("Model15_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_15/Model15_dataset/CNN_Model15_", t, ".png"),height=n_seqs, width=snps_observed)
