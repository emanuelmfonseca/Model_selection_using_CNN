...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_5")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_5/Model5.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_5/Model5.est")
  
  setwd("~/Desktop/CNN_part_II/Model_5/Simulations")
  ...
  write(tpl, "./Model5.tpl")
  write(est, "./Model5.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_5/Simulations/sim",t,"/Model5.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_5/Simulations/sim",t,"/Model5.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model5"))
  
  out <- readLines("Model5_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_5/Model5_dataset/CNN_Model5_", t, ".png"),height=n_seqs, width=snps_observed)
