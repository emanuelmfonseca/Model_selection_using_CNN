...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_23")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_23/Model23.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_23/Model23.est")
  
  setwd("~/Desktop/CNN_part_II/Model_23/Simulations")
  ...
  write(tpl, "./Model23.tpl")
  write(est, "./Model23.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_23/Simulations/sim",t,"/Model23.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_23/Simulations/sim",t,"/Model23.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model23"))
  
  out <- readLines("Model23_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_23/Model23_dataset/CNN_Model23_", t, ".png"),height=n_seqs, width=snps_observed)
