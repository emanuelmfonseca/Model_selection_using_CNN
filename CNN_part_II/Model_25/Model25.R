...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_25")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_25/Model25.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_25/Model25.est")
  
  setwd("~/Desktop/CNN_part_II/Model_25/Simulations")
  ...
  write(tpl, "./Model25.tpl")
  write(est, "./Model25.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_25/Simulations/sim",t,"/Model25.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_25/Simulations/sim",t,"/Model25.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model25"))
  
  out <- readLines("Model25_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_25/Model25_dataset/CNN_Model25_", t, ".png"),height=n_seqs, width=snps_observed)
