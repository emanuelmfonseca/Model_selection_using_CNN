...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_10")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_10/Model10.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_10/Model10.est")
  
  setwd("~/Desktop/CNN_part_II/Model_10/Simulations")
  ...
  write(tpl, "./Model10.tpl")
  write(est, "./Model10.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_10/Simulations/sim",t,"/Model10.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_10/Simulations/sim",t,"/Model10.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model10"))
  
  out <- readLines("Model10_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_10/Model10_dataset/CNN_Model10_", t, ".png"),height=n_seqs, width=snps_observed)
