...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_II/Model_22")
  
  tpl <- readLines("~/Desktop/CNN_part_II/Model_22/Model22.tpl")
  
  est <- readLines("~/Desktop/CNN_part_II/Model_22/Model22.est")
  
  setwd("~/Desktop/CNN_part_II/Model_22/Simulations")
  ...
  write(tpl, "./Model22.tpl")
  write(est, "./Model22.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_II/Model_22/Simulations/sim",t,"/Model22.tpl"), " -e ", paste0("~/Desktop/CNN_part_II/Model_22/Simulations/sim",t,"/Model22.est"), " -E 1 -n 1 -I -s 4009"), intern=T))
  
  setwd(paste0(getwd(), "/Model22"))
  
  out <- readLines("Model22_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_II/Model_22/Model22_dataset/CNN_Model22_", t, ".png"),height=n_seqs, width=snps_observed)
