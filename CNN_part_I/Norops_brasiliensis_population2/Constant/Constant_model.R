...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Constant")
  
  tpl <- readLines("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Constant/Constant.tpl")
  
  est <- readLines("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Constant/Constant.est")
  
  setwd("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Constant/fsc_files")
  ...
  write(tpl, "./Constant.tpl")
  write(est, "./Constant.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Constant/fsc_files/sim",t,"/Constant.tpl"), " -e ", paste0("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Constant/fsc_files/sim",t,"/Constant.est"), " -E 1 -n 1 -I -s 10544"), intern=T))
  
  setwd(paste0(getwd(), "/Constant"))
  
  ### Reading fastsimcoal output
  out <- readLines("Constant_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Constant/Constant_dataset/Pop2_CNN_Constant_", t, ".png"),height=n_seqs, width=snps_observed)
