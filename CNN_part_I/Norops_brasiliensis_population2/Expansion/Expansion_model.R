...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Expansion")
  
  tpl <- readLines("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Expansion/Expansion.tpl")
  
  est <- readLines("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Expansion/Expansion.est")
  
  setwd("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Expansion/fsc_files")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Expansion/fsc_files/sim",t,"/Expansion.tpl"), " -e ", paste0("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Expansion/fsc_files/sim",t,"/Expansion.est"), " -E 1 -n 1 -I -s 10544"), intern=T))
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_I/Norops_brasiliensis_population2/Expansion/Expansion_dataset/Pop2_CNN_Expansion_", t, ".png"),height=n_seqs, width=snps_observed)
