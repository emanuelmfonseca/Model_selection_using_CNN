...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_I/Norops_brasiliensis_population3/Expansion")
  
  tpl <- readLines("~/Desktop/CNN_part_I/Norops_brasiliensis_population3/Expansion/Expansion.tpl")
  
  est <- readLines("~/Desktop/CNN_part_I/Norops_brasiliensis_population3/Expansion/Expansion.est")
  
  setwd("~/Desktop/CNN_part_I/Norops_brasiliensis_population3/Expansion/fsc_files")
  ...
  write(tpl, "./Expansion.tpl")
  write(est, "./Expansion.est")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_I/Norops_brasiliensis_population3/Expansion/fsc_files/sim",t,"/Expansion.tpl"), " -e ", paste0("~/Desktop/CNN_part_I/Norops_brasiliensis_population3/Expansion/fsc_files/sim",t,"/Expansion.est"), " -E 1 -n 1 -I -s 11639"), intern=T))
  
  setwd(paste0(getwd(), "/Expansion"))
  
  ### Reading fastsimcoal output
  out <- readLines("Expansion_1_1.arp")
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_I/Norops_brasiliensis_population3/Expansion/Expansion_dataset/Pop3_CNN_Expansion_", t, ".png"),height=n_seqs, width=snps_observed)
