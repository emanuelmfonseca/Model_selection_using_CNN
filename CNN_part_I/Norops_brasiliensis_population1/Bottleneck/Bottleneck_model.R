...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_I/Norops_brasiliensis_population1/Bottleneck")
  
  tpl <- readLines("~/Desktop/CNN_part_I/Norops_brasiliensis_population1/Bottleneck/Bottleneck.tpl")
  
  est <- readLines("~/Desktop/CNN_part_I/Norops_brasiliensis_population1/Bottleneck/Bottleneck.est")
  
  setwd("~/Desktop/CNN_part_I/Norops_brasiliensis_population1/Bottleneck/fsc_files")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_I/Norops_brasiliensis_population1/Bottleneck/fsc_files/sim",t,"/Bottleneck.tpl"), " -e ", paste0("~/Desktop/CNN_part_I/Norops_brasiliensis_population1/Bottleneck/fsc_files/sim",t,"/Bottleneck.est"), " -E 1 -n 1 -I -s 6340"), intern=T))
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_I/Norops_brasiliensis_population1/Bottleneck/Bottleneck_dataset/Pop1_CNN_Bottleneck_", t, ".png"),height=n_seqs, width=snps_observed)
