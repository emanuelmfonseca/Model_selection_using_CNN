...
CNN <- function(t){
  ...
  setwd("~/Desktop/CNN_part_I/Norops_planiceps/Constant")
  
  tpl <- readLines("~/Desktop/CNN_part_I/Norops_planiceps/Constant/Constant.tpl")
  
  est <- readLines("~/Desktop/CNN_part_I/Norops_planiceps/Constant/Constant.est")
  
  setwd("~/Desktop/CNN_part_I/Norops_planiceps/Constant/fsc_files")
  ...
  quiet(system(paste0(path_to_fastsimcoal, " -t ", paste0("~/Desktop/CNN_part_I/Norops_planiceps/Constant/fsc_files/sim",t,"/Constant.tpl"), " -e ", paste0("~/Desktop/CNN_part_I/Norops_planiceps/Constant/fsc_files/sim",t,"/Constant.est"), " -E 1 -n 1 -I -s 11639"), intern=T))
  ...
  if(!length.snps < snps_observed){
    ...
    png(filename=paste0("~/Desktop/CNN_part_I/Norops_planiceps/Constant/Constant_dataset/N_planiceps_CNN_Bottleneck_", t, ".png"),height=n_seqs, width=snps_observed)
